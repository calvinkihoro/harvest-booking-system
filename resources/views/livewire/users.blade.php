...
<div class="py-12 min-height-screen overflow-y-auto">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="px-2 py-4 flex flex-col md:flex-row justify-between items-center mx-4">
            <h1 class="capitalize my-2"><span><a href="{{route('dashAD_')}}" class="text-blue-500 hover:text-blue-700">Home</a></span><span> / </span>Manage User Account</h1>
            ...
            <x-jet-button wire:click="showCreateModel" class="text-center" >Add New Account</x-jet-button>
        </div>
                ...
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            @else
                                <tr>
                                    <td colspan="5" class="text-center px-4 py-20 text-blue-600">No Users Accont</td>
                                </tr>
                            @endif
                            <!-- More people... -->
                            </tbody>
        ...
        <x-jet-dialog-modal wire:model="createModel">
            ...
            <x-slot name="title" >
                <h2 class="my-2 text-center text-lg text-blue-500">Register New Account</h2>
            </x-slot>
            <x-slot name="content">
                                ...
                                <div class="w-full">
                                    ...
                                    <form wire:submit.prevent="save" class="flex flex-col w-full">
                                        ...
                                        <x-jet-button class="w-full mx-auto my-10">
                                            <p class="text-center text-white mx-auto">Add Account</p></x-jet-button>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        <x-jet-dialog-modal wire:model="updateModel">
            ...
            <x-slot name="title" >
                <h2 class="my-2 text-center text-lg text-green-500">Update User Update Dangote</h2>
            </x-slot>
            <x-slot name="content">
                            ...
                            <div class="flex items-center justify-center p-2 sm:p-4">
                                <div class="w-full">
                                    ...
                                    <form wire:submit.prevent="update" class="flex flex-col w-full">
                                        ...
                                        <x-jet-button class="w-full mx-auto my-10">
                                            <p class="text-center mx-auto text-white">Update Data</p></x-jet-button>
                                    </form>
                                </div>
                            </div>
                        </div>
